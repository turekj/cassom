...
\begin{figure}[ht!]
	\begin{minipage}{\textwidth}
		...
		\footnotetext{Sharding (od \emph{shard} - ang. kawałek) - technika polegająca na podziale zbioru danych na niezależne partycje w~zależności od ich cech, na przykład grupując użytkowników po lokalizacji geograficznej.~\cite{database_sharding}}
