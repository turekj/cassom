...
Spośród wymienionych powyżej komponentów najbardziej rozbudowany służy do opisu modelu logicznego za pomocą metadanych. Składają się na niego moduły zaprezentowane na diagramie~\ref{fig:omc_metadata_components}.
...
Komponenty przedstawione na diagramie~\ref{fig:omc_metadata_components} mają następującą odpowiedzialność:
