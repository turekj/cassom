...
OMC posiada dwa mechanizmy, które automatyzują proces denormalizacji:

\begin{description}
	\item[przez pole] umożliwia włączenie zdenormalizowanych pól do modelu,
	\item[przez tabelę] umożliwia ekstrakcję danych do osobnej tabeli.
\end{description}
